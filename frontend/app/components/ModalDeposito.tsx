              ...
              <div className="w-full md:w-1/3">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button onClick={() => setMetodo('mbway')} className={`relative overflow-hidden p-4 rounded-xl border transition-all duration-300 flex items-center gap-4 ${metodo === 'mbway' ? 'bg-[#00a8e8]/10 border-[#00a8e8] shadow-[0_0_20px_rgba(0,168,232,0.15)] scale-[1.02]' : 'bg-white/[0.02] border-white/5 hover:border-white/20'}`}>
                    ...
                    {/* VETOR NATIVO MB WAY */}
                    <div className="w-20 h-8 bg-white rounded flex items-center justify-center shadow-inner shrink-0 px-1">
                      <svg viewBox="0 0 115 30" className="h-full py-1.5" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0" y="3" width="24" height="24" rx="4" fill="#00a8e8" />
                        <circle cx="6" cy="9" r="1.5" fill="white"/><circle cx="12" cy="9" r="1.5" fill="white"/><circle cx="18" cy="9" r="1.5" fill="white"/>
                        <circle cx="6" cy="15" r="1.5" fill="white"/><circle cx="12" cy="15" r="1.5" fill="white"/><circle cx="18" cy="15" r="1.5" fill="white"/>
                        <circle cx="6" cy="21" r="1.5" fill="white"/><circle cx="12" cy="21" r="1.5" fill="white"/><circle cx="18" cy="21" r="1.5" fill="white"/>
                        <text x="30" y="22" fontFamily="Arial, Helvetica, sans-serif" fontWeight="900" fontSize="21" fill="#00a8e8" letterSpacing="-0.5">MB WAY</text>
                      </svg>
                    </div>
                  ...
                  <button onClick={() => setMetodo('cartao')} className={`relative overflow-hidden p-4 rounded-xl border transition-all duration-300 flex items-center gap-4 ${metodo === 'cartao' ? 'bg-purple-500/10 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.15)] scale-[1.02]' : 'bg-white/[0.02] border-white/5 hover:border-white/20'}`}>
                    ...
                    {/* VETORES NATIVOS VISA & MASTERCARD */}
                    <div className="w-20 h-8 bg-white rounded flex items-center justify-center shadow-inner gap-2 shrink-0 px-1">
                      {/* VISA */}
                      <svg viewBox="0 0 38 12" className="h-2.5" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.653 0.288H11.535L8.27 11.52H11.39L12.013 9.791H15.828L16.19 11.52H18.995L14.653 0.288ZM12.868 7.391L13.935 4.38L14.992 7.391H12.868ZM27.423 0.288H24.811C24.086 0.288 23.473 0.697 23.166 1.348L19.742 11.52H23.013L23.666 9.712H27.653L28.026 11.52H30.826L27.423 0.288ZM24.582 7.151L25.666 4.095L26.702 7.151H24.582ZM37.382 0.288H34.426C33.743 0.288 33.155 0.672 32.844 1.321L28.536 11.52H31.815L32.473 9.712H36.468L36.84 11.52H39.638L37.382 0.288ZM33.394 7.151L34.481 4.095L35.517 7.151H33.394ZM7.994 0.288L5.352 7.915L5.05 6.368C4.852 5.093 3.823 4.103 2.508 3.655L0 2.802V0.288H7.994Z" fill="#1434CB"/>
                      </svg>
                      {/* MASTERCARD */}
                      <svg viewBox="0 0 36 24" className="h-4" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="12" fill="#EB001B"/>
                        <circle cx="24" cy="12" r="12" fill="#F79E1B"/>
                        <path d="M18 20.485A11.956 11.956 0 0 0 21.36 12 11.956 11.956 0 0 0 18 3.515 11.956 11.956 0 0 0 14.64 12 11.956 11.956 0 0 0 18 20.485Z" fill="#FF5F00"/>
                      </svg>
                    </div>
                  ...
                  <button onClick={() => setMetodo('crypto')} className={`relative overflow-hidden p-4 rounded-xl border transition-all duration-300 flex items-center gap-4 ${metodo === 'crypto' ? 'bg-amber-500/10 border-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.15)] scale-[1.02]' : 'bg-white/[0.02] border-white/5 hover:border-white/20'}`}>
                    ...
                    {/* VETORES NATIVOS BTC & ETH */}
                    <div className="w-20 h-8 flex items-center justify-center gap-1.5 bg-black/40 rounded shadow-inner border border-white/5 shrink-0">
                      <svg viewBox="0 0 24 24" className="h-5 w-5 drop-shadow-md" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="12" fill="#F7931A"/>
                        <path d="M16.6 10.3c.3-2-1.3-3.1-3.6-3.8l.7-3-1.8-.4-.7 2.9c-.5-.1-1-.2-1.5-.4l.7-3-1.8-.4-.7 3c-.4-.1-.8-.2-1.2-.3l0 0-2.5-.6-.5 1.9s1.3.3 1.3.3c.7.2.9.6.8 1.1l-1.6 6.3c-.1.2-.4.4-.8.3 0 0-1.3-.3-1.3-.3l-1 2.2 2.4.6c.5.1 1 .2 1.4.3l-.7 3 1.8.4.7-3c.5.1 1 .3 1.5.4l-.7 2.9 1.8.4.7-3c2.9.5 5.1.3 5.9-2.3.6-2 .1-3.1-1.1-3.9 1-.2 1.7-.8 1.9-2zm-2.8 4.7c-.5 2.1-4 1-5.1.7l.9-3.7c1.1.3 4.7.8 4.2 3zm.5-4c-.4 1.8-3 1-3.8.8l.8-3.4c.8.2 3.4.7 3 2.6z" fill="white"/>
                      </svg>
                      <svg viewBox="0 0 24 24" className="h-5 w-5 drop-shadow-md" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.8 0L11.6 1v15.7l.2.2 5.5-3.3L11.8 0z" fill="#9CA3AF"/>
                        <path d="M11.8 0L6.3 13.7l5.5 3.3V0z" fill="#E5E7EB"/>
                        <path d="M11.8 17.5l-.1.1v6.1l.1.3 5.5-7.8-5.5 1.3z" fill="#4B5563"/>
                        <path d="M11.8 24v-6.5l-5.5-1.3 5.5 7.8z" fill="#9CA3AF"/>
                        <path d="M11.8 16.2l5.5-3.3-5.5-2.5v5.8z" fill="#374151"/>
                        <path d="M6.3 12.9l5.5 3.3v-5.8l-5.5 2.5z" fill="#6B7280"/>
                      </svg>
                    </div>
                  ...
                  <button onClick={() => setMetodo('skins')} className={`relative overflow-hidden p-4 rounded-xl border transition-all duration-300 flex items-center gap-4 ${metodo === 'skins' ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.15)] scale-[1.02]' : 'bg-white/[0.02] border-white/5 hover:border-white/20'}`}>
                    ...
                    {/* LOGO CS2 ESTILIZADO EM TEXTO (NUNCA FALHA) */}
                    <div className="w-20 h-8 flex items-center justify-center bg-black/40 rounded shadow-inner border border-white/5 shrink-0">
                      <span className="text-emerald-500 font-black italic tracking-tighter text-lg drop-shadow-[0_0_5px_rgba(16,185,129,0.5)]">CS2</span>
                    </div>
