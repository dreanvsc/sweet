...
export default function Sidebar({ view, setView, saldo, userId, userData }: any) {
  ...
  // 🔥 O LIMPA-NEVES (FUNÇÃO DE LOGOUT COMPLETA)
  const handleLogout = () => {
    ...
    // 2. Limpa todos os cookies ativos (para garantir que a sessão da Steam descola)
    ...
    // 3. Redireciona de raiz em vez de dar apenas reload
